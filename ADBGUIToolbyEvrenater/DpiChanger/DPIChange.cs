...
namespace ADBGUIToolbyEvrenater.DpiChanger
{
    class DPIChange
    {
        Form form1;
        ...
        public DPIChange()
        {
            ...
            form1.Text = "DPI Changer";
            resultLabel.Text = "Change DPI";
            changeButton.Text = "Change";
            resetButton.Text = "Reset DPI";
        ...
        private void BackgroundWorker2_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {
                // Perform a time consuming operation and report progress.
                ProcessCreate.Command("adb shell wm density reset");
            }
        }
        ...
        private void BackgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {
                // Perform a time consuming operation and report progress.
                ProcessCreate.Command("adb shell wm density " + numericUpDown.Value);
            }
        }
